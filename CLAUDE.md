...
하나(3채널 884 MB/s)이고 그것은 ±2초든 ±3초든 같다. 그래서 **±3초도 된다** — 3채널 120초, 덤프
22건(13 GB)을 쓰는 중에 유실 8/7/8(0.053%), 덤프 전부 `N frame(s) of N held`. 카메라당 3.58 GB,
3채널 10.74 GB다. 한계는 초가 아니라 RAM이고, 그 문턱을 `HostMemory`가 지킨다.
